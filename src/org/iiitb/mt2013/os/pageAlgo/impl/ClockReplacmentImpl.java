...
public class ClockReplacmentImpl extends PageReplacementAlgo {
	...
	public ClockReplacmentImpl(List<Integer> pageNos, long memorySize,
	...
	public List<MemoryPrint> executeAlgo() throws InvalidMemoryUnitException {
		...
		for (Page page : this.pages) {
			...
			if (this.freeFrames > 0) {
				...
				pageReferenced = pointer.intValue();
